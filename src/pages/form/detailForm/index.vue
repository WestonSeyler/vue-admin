  ...
  <div>
    ...
    >
      <n-descriptions label-placement="left" class="py-2">
        ...
        <n-descriptions-item label="邮箱">wowjoy@qq.com</n-descriptions-item>
        <n-descriptions-item label="地址"
          >浙江省杭州市拱墅区</n-descriptions-item
        >
